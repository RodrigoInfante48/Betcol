...
export const TEAM_PROFILES: Record<string, TeamProfile> = {
  ...
  'Países Bajos': {
    coach: 'Ronald Koeman',
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_the_Netherlands.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Royal_Dutch_Football_Association_logo.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Bart Verbruggen',        position: 'GK', club: 'Brighton & Hove Albion' },
      { number: 12, name: 'Mark Flekken',           position: 'GK', club: 'Brentford' },
      { number: 22, name: 'Nick Olij',              position: 'GK', club: 'Sparta Rotterdam' },
      // Defensas
      { number: 2,  name: 'Denzel Dumfries',        position: 'DF', club: 'Inter Milan' },
      { number: 3,  name: 'Jurriën Timber',         position: 'DF', club: 'Arsenal' },
      { number: 4,  name: 'Virgil van Dijk',        position: 'DF', club: 'Liverpool' },
      { number: 5,  name: 'Nathan Aké',             position: 'DF', club: 'Manchester City' },
      { number: 6,  name: 'Stefan de Vrij',         position: 'DF', club: 'Inter Milan' },
      { number: 15, name: 'Matthijs de Ligt',       position: 'DF', club: 'Manchester United' },
      { number: 17, name: 'Tyrell Malacia',         position: 'DF', club: 'Manchester United' },
      // Mediocampistas
      { number: 8,  name: 'Tijjani Reijnders',      position: 'MF', club: 'AC Milan' },
      { number: 10, name: 'Xavi Simons',            position: 'MF', club: 'Paris Saint-Germain' },
      { number: 14, name: 'Teun Koopmeiners',       position: 'MF', club: 'Juventus' },
      { number: 16, name: 'Mats Wieffer',           position: 'MF', club: 'Brighton & Hove Albion' },
      { number: 18, name: 'Ryan Gravenberch',       position: 'MF', club: 'Liverpool' },
      { number: 20, name: 'Joey Veerman',           position: 'MF', club: 'PSV Eindhoven' },
      { number: 24, name: 'Frenkie de Jong',        position: 'MF', club: 'FC Barcelona' },
      // Delanteros
      { number: 7,  name: 'Noa Lang',               position: 'FW', club: 'PSV Eindhoven' },
      { number: 9,  name: 'Wout Weghorst',          position: 'FW', club: 'TSG Hoffenheim' },
      { number: 11, name: 'Cody Gakpo',             position: 'FW', club: 'Liverpool' },
      { number: 13, name: 'Brian Brobbey',          position: 'FW', club: 'Ajax' },
      { number: 19, name: 'Donyell Malen',          position: 'FW', club: 'Aston Villa' },
      { number: 21, name: 'Memphis Depay',          position: 'FW', club: 'Corinthians' },
    ],
  },
  ...
  'Japón': {
    ...
    formation: '4-2-3-1',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Japan.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Japan_Football_Association_logo.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Zion Suzuki',            position: 'GK', club: 'Parma' },
      { number: 12, name: 'Kenji Hiratsuka',        position: 'GK', club: 'Urawa Red Diamonds' },
      { number: 23, name: 'Yuta Gonda',             position: 'GK', club: 'Portimonense' },
      // Defensas
      { number: 2,  name: 'Miki Yamane',            position: 'DF', club: 'Kashima Antlers' },
      { number: 3,  name: 'Yuta Nakayama',          position: 'DF', club: 'PSV Eindhoven' },
      { number: 4,  name: 'Ko Itakura',             position: 'DF', club: 'Borussia Mönchengladbach' },
      { number: 5,  name: 'Shogo Taniguchi',        position: 'DF', club: 'Kawasaki Frontale' },
      { number: 6,  name: 'Takehiro Tomiyasu',      position: 'DF', club: 'Arsenal' },
      { number: 22, name: 'Hiroki Ito',             position: 'DF', club: 'Bayern Munich' },
      // Mediocampistas
      { number: 7,  name: 'Daichi Kamada',          position: 'MF', club: 'Crystal Palace' },
      { number: 8,  name: 'Wataru Endō',            position: 'MF', club: 'Liverpool' },
      { number: 10, name: 'Takefusa Kubo',          position: 'MF', club: 'Real Sociedad' },
      { number: 13, name: 'Hidemasa Morita',        position: 'MF', club: 'Sporting CP' },
      { number: 14, name: 'Ao Tanaka',              position: 'MF', club: 'Fortuna Düsseldorf' },
      { number: 17, name: 'Kaoru Mitoma',           position: 'MF', club: 'Brighton & Hove Albion' },
      { number: 21, name: 'Ritsu Doan',             position: 'MF', club: 'SC Freiburg' },
      // Delanteros
      { number: 9,  name: 'Ayase Ueda',             position: 'FW', club: 'Feyenoord' },
      { number: 11, name: 'Daizen Maeda',           position: 'FW', club: 'Celtic' },
      { number: 15, name: 'Kyogo Furuhashi',        position: 'FW', club: 'Celtic' },
      { number: 16, name: 'Junya Ito',              position: 'FW', club: 'Stade de Reims' },
      { number: 18, name: 'Reo Hatate',             position: 'FW', club: 'Celtic' },
      { number: 19, name: 'Shuto Machino',          position: 'FW', club: 'KAA Gent' },
      { number: 20, name: 'Keito Nakamura',         position: 'FW', club: 'Stade de Reims' },
    ],
  },
  ...
  'Suecia': {
    ...
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Sweden.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Svenska_Fotbollf%C3%B6rbundet_logo.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Robin Olsen',            position: 'GK', club: 'Aston Villa' },
      { number: 12, name: 'Oscar Linnér',           position: 'GK', club: 'Bayer Leverkusen' },
      { number: 23, name: 'Pontus Dahlberg',        position: 'GK', club: 'IFK Göteborg' },
      // Defensas
      { number: 2,  name: 'Emil Krafth',            position: 'DF', club: 'Newcastle United' },
      { number: 3,  name: 'Ludwig Augustinsson',    position: 'DF', club: 'Villarreal' },
      { number: 4,  name: 'Isak Hien',              position: 'DF', club: 'Atalanta' },
      { number: 5,  name: 'Victor Nilsson Lindelöf', position: 'DF', club: 'Manchester United' },
      { number: 6,  name: 'Carl Starfelt',          position: 'DF', club: 'Celta Vigo' },
      { number: 15, name: 'Filip Bengtsson',        position: 'DF', club: '1. FC Nürnberg' },
      { number: 22, name: 'Joakim Nilsson',         position: 'DF', club: 'Elche CF' },
      // Mediocampistas
      { number: 8,  name: 'Jens Cajuste',           position: 'MF', club: 'Brentford' },
      { number: 10, name: 'Emil Forsberg',          position: 'MF', club: 'New York Red Bulls' },
      { number: 14, name: 'Dejan Kulusevski',       position: 'MF', club: 'Tottenham Hotspur' },
      { number: 17, name: 'Mattias Svanberg',       position: 'MF', club: 'VfL Wolfsburg' },
      { number: 20, name: 'Samuel Dahl',            position: 'MF', club: 'Djurgårdens IF' },
      { number: 21, name: 'Jesper Karlsson',        position: 'MF', club: 'AZ Alkmaar' },
      { number: 24, name: 'Gustav Isaksen',         position: 'MF', club: 'SS Lazio' },
      // Delanteros
      { number: 7,  name: 'Viktor Claesson',        position: 'FW', club: 'IFK Göteborg' },
      { number: 9,  name: 'Viktor Gyökeres',        position: 'FW', club: 'Sporting CP' },
      { number: 11, name: 'Alexander Isak',         position: 'FW', club: 'Newcastle United' },
      { number: 13, name: 'Jordan Larsson',         position: 'FW', club: 'Club Brugge' },
      { number: 16, name: 'Anthony Elanga',         position: 'FW', club: 'Nottingham Forest' },
      { number: 19, name: 'Williot Swedberg',       position: 'FW', club: 'RC Celta Vigo' },
    ],
  },
  ...
  'Túnez': {
    ...
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Tunisia.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Logo_FTF.png',
    players: [
      // Porteros
      { number: 1,  name: 'Aymen Dahmen',           position: 'GK', club: 'Montpellier HSC' },
      { number: 12, name: 'Farouk Ben Mustapha',    position: 'GK', club: 'Kasımpaşa SK' },
      { number: 23, name: 'Moez Ben Cherifia',      position: 'GK', club: 'Espérance Sportive de Tunis' },
      // Defensas
      { number: 2,  name: 'Wajdi Kechrida',         position: 'DF', club: 'Al-Ahli SC' },
      { number: 3,  name: 'Ali Abdi',               position: 'DF', club: 'Troyes AC' },
      { number: 4,  name: 'Dylan Bronn',            position: 'DF', club: 'Salernitana' },
      { number: 5,  name: 'Bilel Ifa',              position: 'DF', club: 'Espérance Sportive de Tunis' },
      { number: 6,  name: 'Montassar Talbi',        position: 'DF', club: 'RC Lens' },
      { number: 15, name: 'Yassine Meriah',         position: 'DF', club: 'Espérance Sportive de Tunis' },
      { number: 22, name: 'Hamza Mathlouthi',       position: 'DF', club: 'Club Africain' },
      // Mediocampistas
      { number: 7,  name: 'Ghaylane Chaalali',      position: 'MF', club: 'Espérance Sportive de Tunis' },
      { number: 8,  name: 'Ellyes Skhiri',          position: 'MF', club: 'Eintracht Frankfurt' },
      { number: 10, name: 'Hannibal Mejbri',        position: 'MF', club: 'Trabzonspor' },
      { number: 13, name: 'Anis Ben Slimane',       position: 'MF', club: 'Brøndby IF' },
      { number: 14, name: 'Mohamed Drager',         position: 'MF', club: 'Middlesbrough' },
      { number: 17, name: 'Naïm Sliti',             position: 'MF', club: 'CS Sfaxien' },
      { number: 20, name: 'Ferjani Sassi',          position: 'MF', club: 'Al-Ain FC' },
      // Delanteros
      { number: 9,  name: 'Issam Jebali',           position: 'FW', club: 'Odense BK' },
      { number: 11, name: 'Youssef Msakni',         position: 'FW', club: 'Al-Arabi SC' },
      { number: 16, name: 'Taha Yassine Khenissi',  position: 'FW', club: 'Club Africain' },
      { number: 18, name: 'Seifeddine Jaziri',      position: 'FW', club: 'Panathinaikos' },
      { number: 19, name: 'Sayfallah Ltaief',       position: 'FW', club: 'Espérance Sportive de Tunis' },
      { number: 21, name: 'Elias Achouri',          position: 'FW', club: 'Troyes AC' },
    ],
  },
  ...
  'España': {
    ...
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Spain.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Real_Federaci%C3%B3n_Espa%C3%B1ola_de_F%C3%BAtbol_logo.svg',
    players: [
      { number: 1,  name: 'David Raya',            position: 'GK', club: 'Arsenal' },
      { number: 13, name: 'Joan García',            position: 'GK', club: 'Espanyol' },
      { number: 23, name: 'Unai Simón',             position: 'GK', club: 'Athletic Club' },
      { number: 2,  name: 'Marc Pubill',            position: 'DF', club: 'Atlético de Madrid' },
      { number: 3,  name: 'Alejandro Grimaldo',     position: 'DF', club: 'Bayer Leverkusen' },
      { number: 4,  name: 'Eric García',            position: 'DF', club: 'Girona' },
      { number: 12, name: 'Pedro Porro',            position: 'DF', club: 'Tottenham Hotspur' },
      { number: 14, name: 'Aymeric Laporte',        position: 'DF', club: 'Al Nassr' },
      { number: 22, name: 'Pau Cubarsí',            position: 'DF', club: 'Barcelona' },
      { number: 24, name: 'Marc Cucurella',         position: 'DF', club: 'Chelsea' },
      { number: 5,  name: 'Marcos Llorente',        position: 'MF', club: 'Atlético de Madrid' },
      { number: 6,  name: 'Mikel Merino',           position: 'MF', club: 'Arsenal' },
      { number: 8,  name: 'Fabián Ruiz',            position: 'MF', club: 'Paris Saint-Germain' },
      { number: 9,  name: 'Gavi',                   position: 'MF', club: 'Barcelona' },
      { number: 10, name: 'Dani Olmo',              position: 'MF', club: 'Barcelona' },
      { number: 15, name: 'Álex Baena',             position: 'MF', club: 'Villarreal' },
      { number: 16, name: 'Rodri',                  position: 'MF', club: 'Manchester City' },
      { number: 18, name: 'Martín Zubimendi',       position: 'MF', club: 'Arsenal' },
      { number: 20, name: 'Pedri',                  position: 'MF', club: 'Barcelona' },
      { number: 25, name: 'Víctor Muñoz',           position: 'MF', club: 'Girona' },
      { number: 7,  name: 'Ferran Torres',          position: 'FW', club: 'Barcelona' },
      { number: 11, name: 'Yeremy Pino',            position: 'FW', club: 'Villarreal' },
      { number: 17, name: 'Nico Williams',          position: 'FW', club: 'Athletic Club' },
      { number: 19, name: 'Lamine Yamal',           position: 'FW', club: 'Barcelona' },
      { number: 21, name: 'Mikel Oyarzabal',        position: 'FW', club: 'Real Sociedad' },
      { number: 26, name: 'Borja Iglesias',         position: 'FW', club: 'Real Betis' },
    ],
  },
  ...
  'Cabo Verde': {
    coach: 'Bubista',
    formation: '4-2-3-1',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Cape_Verde.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Federacao_Cabo-verdiana_de_Futebol.png',
    players: [
      { number: 1,  name: 'Vozinha',                position: 'GK', club: 'Operário' },
      { number: 12, name: 'Márcio Rosa',            position: 'GK', club: 'Académica' },
      { number: 23, name: 'CJ Dos Santos',          position: 'GK', club: 'San Diego FC' },
      { number: 2,  name: 'Steven Moreira',         position: 'DF', club: 'Columbus Crew' },
      { number: 3,  name: 'Sidny Lopes Cabral',     position: 'DF', club: 'Benfica' },
      { number: 4,  name: 'Logan Costa',            position: 'DF', club: 'Villarreal' },
      { number: 5,  name: 'Roberto Lopes',          position: 'DF', club: 'Shamrock Rovers' },
      { number: 6,  name: 'Wagner Pina',            position: 'DF', club: 'Trabzonspor' },
      { number: 13, name: 'João Paulo Fernandes',   position: 'DF', club: 'FCSB' },
      { number: 14, name: 'Kelvin Pires',           position: 'DF', club: 'SJK Seinäjoki' },
      { number: 15, name: 'Ianique Tavares',        position: 'DF', club: 'Torreense' },
      { number: 22, name: 'Edilson Borges',         position: 'DF', club: 'Al-Bataeh' },
      { number: 7,  name: 'Jamiro Monteiro',        position: 'MF', club: 'PEC Zwolle' },
      { number: 8,  name: 'Laros Duarte',           position: 'MF', club: 'Puskás Akadémia' },
      { number: 16, name: 'Telmo Arcanjo',          position: 'MF', club: 'Vitória Guimarães' },
      { number: 17, name: 'Yannick Semedo',         position: 'MF', club: 'Farense' },
      { number: 18, name: 'Deroy Duarte',           position: 'MF', club: 'Ludogorets' },
      { number: 19, name: 'Kevin Pina',             position: 'MF', club: 'Krasnodar' },
      { number: 9,  name: 'Ryan Mendes',            position: 'FW', club: 'Iğdır FK' },
      { number: 10, name: 'Jovane Cabral',          position: 'FW', club: 'Estrela Amadora' },
      { number: 11, name: 'Dailon Livramento',      position: 'FW', club: 'Casa Pia' },
      { number: 20, name: 'Garry Rodrigues',        position: 'FW', club: 'Apollon Limassol' },
      { number: 21, name: 'Nuno Da Costa',          position: 'FW', club: 'Başakşehir' },
    ],
  },
  ...
  'Arabia Saudita': {
    ...
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Saudi_Arabia.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Saudi_Arabia_Football_Federation_logo.svg',
    players: [
      { number: 1,  name: 'Mohammed Al Owais',      position: 'GK', club: 'Al Hilal' },
      { number: 12, name: 'Nawaf Al Aqidi',         position: 'GK', club: 'Al Nassr' },
      { number: 23, name: 'Ahmed Al Kassar',        position: 'GK', club: 'Al Qadsiah' },
      { number: 2,  name: 'Saud Abdulhamid',        position: 'DF', club: 'RC Lens' },
      { number: 3,  name: 'Hassan Tambakti',        position: 'DF', club: 'Al Hilal' },
      { number: 4,  name: 'Ali Lajami',             position: 'DF', club: 'Al Hilal' },
      { number: 5,  name: 'Abdulelah Al Amri',      position: 'DF', club: 'Al Nassr' },
      { number: 13, name: 'Hassan Kadesh',          position: 'DF', club: 'Al Ittihad' },
      { number: 14, name: 'Ali Majrashi',           position: 'DF', club: 'Al Ahli' },
      { number: 22, name: 'Moteb Al Harbi',         position: 'DF', club: 'Al Hilal' },
      { number: 6,  name: 'Mohammed Kanno',         position: 'MF', club: 'Al Hilal' },
      { number: 8,  name: 'Abdullah Al Khaibari',   position: 'MF', club: 'Al Nassr' },
      { number: 15, name: 'Nasser Al Dawsari',      position: 'MF', club: 'Al Hilal' },
      { number: 16, name: 'Musab Al Juwayr',        position: 'MF', club: 'Al Qadsiah' },
      { number: 17, name: 'Alaa Al Hajji',          position: 'MF', club: 'NEOM SC' },
      { number: 18, name: 'Sultan Mandash',         position: 'MF', club: 'Al Hilal' },
      { number: 21, name: 'Ziyad Al Johani',        position: 'MF', club: 'Al Ahli' },
      { number: 7,  name: 'Salem Al-Dawsari',       position: 'FW', club: 'Al Hilal' },
      { number: 9,  name: 'Feras Al Buraikan',      position: 'FW', club: 'Al Ahli' },
      { number: 10, name: 'Saleh Al Shehri',        position: 'FW', club: 'Al Ittihad' },
      { number: 11, name: 'Abdullah Al Hamdan',     position: 'FW', club: 'Al Nassr' },
      { number: 19, name: 'Ayman Yahya',            position: 'FW', club: 'Al Nassr' },
      { number: 20, name: 'Khalid Al Ghannam',      position: 'FW', club: 'Al Ettifaq' },
    ],
  },
  ...
  'Uruguay': {
    ...
    formation: '3-3-3-1',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Uruguay.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Asociaci%C3%B3n_Uruguaya_de_F%C3%BAtbol_logo.svg',
    players: [
      { number: 1,  name: 'Sergio Rochet',          position: 'GK', club: 'Internacional' },
      { number: 12, name: 'Santiago Mele',          position: 'GK', club: 'Monterrey' },
      { number: 23, name: 'Fernando Muslera',       position: 'GK', club: 'Estudiantes' },
      { number: 2,  name: 'José María Giménez',     position: 'DF', club: 'Atlético de Madrid' },
      { number: 3,  name: 'Sebastián Cáceres',      position: 'DF', club: 'CF América' },
      { number: 4,  name: 'Ronald Araújo',          position: 'DF', club: 'Barcelona' },
      { number: 13, name: 'Guillermo Varela',       position: 'DF', club: 'Flamengo' },
      { number: 16, name: 'Mathías Olivera',        position: 'DF', club: 'Napoli' },
      { number: 17, name: 'Matías Viña',            position: 'DF', club: 'River Plate' },
      { number: 22, name: 'Joaquín Piquerez',       position: 'DF', club: 'Palmeiras' },
      { number: 24, name: 'Santiago Bueno',         position: 'DF', club: 'Wolverhampton Wanderers' },
      { number: 25, name: 'Juan Manuel Sanabria',   position: 'DF', club: 'Real Salt Lake' },
      { number: 5,  name: 'Manuel Ugarte',          position: 'MF', club: 'Manchester United' },
      { number: 6,  name: 'Rodrigo Bentancur',      position: 'MF', club: 'Tottenham Hotspur' },
      { number: 7,  name: 'Nicolás de la Cruz',     position: 'MF', club: 'Flamengo' },
      { number: 8,  name: 'Federico Valverde',      position: 'MF', club: 'Real Madrid' },
      { number: 10, name: 'Giorgian De Arrascaeta', position: 'MF', club: 'Flamengo' },
      { number: 14, name: 'Agustín Canobbio',       position: 'MF', club: 'Fluminense' },
      { number: 15, name: 'Emiliano Martínez',      position: 'MF', club: 'Palmeiras' },
      { number: 18, name: 'Rodrigo Zalazar',        position: 'MF', club: 'Braga' },
      { number: 20, name: 'Maximiliano Araújo',     position: 'MF', club: 'Sporting CP' },
      { number: 21, name: 'Facundo Pellistri',      position: 'MF', club: 'Panathinaikos' },
      { number: 26, name: 'Brian Rodríguez',        position: 'MF', club: 'CF América' },
      { number: 9,  name: 'Darwin Núñez',           position: 'FW', club: 'Al Hilal' },
      { number: 11, name: 'Rodrigo Aguirre',        position: 'FW', club: 'Tigres' },
      { number: 19, name: 'Federico Viñas',         position: 'FW', club: 'Real Oviedo' },
    ],
  },
  ...
  'Francia': {
    ...
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_France.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/FFF_logo_2024.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Mike Maignan',          position: 'GK', club: 'AC Milan' },
      { number: 16, name: 'Alphonse Areola',        position: 'GK', club: 'West Ham United' },
      { number: 23, name: 'Brice Samba',            position: 'GK', club: 'Lens' },
      // Defensas
      { number: 2,  name: 'Benjamin Pavard',        position: 'DF', club: 'Inter Milan' },
      { number: 3,  name: 'Lucas Hernández',        position: 'DF', club: 'Paris Saint-Germain' },
      { number: 4,  name: 'Dayot Upamecano',        position: 'DF', club: 'Bayern München' },
      { number: 5,  name: 'Jules Koundé',           position: 'DF', club: 'Barcelona' },
      { number: 20, name: 'Theo Hernández',         position: 'DF', club: 'AC Milan' },
      { number: 21, name: 'Ibrahima Konaté',        position: 'DF', club: 'Liverpool' },
      { number: 22, name: 'Jonathan Clauss',        position: 'DF', club: 'Nice' },
      // Mediocampistas
      { number: 6,  name: 'Eduardo Camavinga',      position: 'MF', club: 'Real Madrid' },
      { number: 8,  name: 'Aurélien Tchouaméni',   position: 'MF', club: 'Real Madrid' },
      { number: 11, name: 'Ousmane Dembélé',        position: 'MF', club: 'Paris Saint-Germain' },
      { number: 13, name: 'N\'Golo Kanté',          position: 'MF', club: 'Al-Ittihad' },
      { number: 14, name: 'Adrien Rabiot',          position: 'MF', club: 'Marseille' },
      { number: 18, name: 'Mattéo Guendouzi',       position: 'MF', club: 'Marseille' },
      { number: 19, name: 'Youssouf Fofana',        position: 'MF', club: 'AC Milan' },
      // Delanteros
      { number: 7,  name: 'Antoine Griezmann',      position: 'FW', club: 'Atlético de Madrid' },
      { number: 9,  name: 'Olivier Giroud',         position: 'FW', club: 'Los Angeles FC' },
      { number: 10, name: 'Kylian Mbappé',          position: 'FW', club: 'Real Madrid' },
      { number: 12, name: 'Randal Kolo Muani',      position: 'FW', club: 'Juventus' },
      { number: 15, name: 'Marcus Thuram',          position: 'FW', club: 'Inter Milan' },
      { number: 17, name: 'Bradley Barcola',        position: 'FW', club: 'Paris Saint-Germain' },
    ],
  },
  ...
  'Senegal': {
    coach: 'Aliou Cissé',
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Senegal.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Logo_of_the_Senegal_national_football_team.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Édouard Mendy',          position: 'GK', club: 'Al-Ahli' },
      { number: 16, name: 'Seny Dieng',             position: 'GK', club: 'Middlesbrough' },
      { number: 23, name: 'Alfred Gomis',           position: 'GK', club: 'Rennes' },
      // Defensas
      { number: 2,  name: 'Formose Mendy',          position: 'DF', club: 'Lorient' },
      { number: 3,  name: 'Abdou Diallo',           position: 'DF', club: 'RB Leipzig' },
      { number: 4,  name: 'Pape Abou Cissé',        position: 'DF', club: 'Olympiakos' },
      { number: 5,  name: 'Kalidou Koulibaly',      position: 'DF', club: 'Al-Hilal' },
      { number: 12, name: 'Ismail Jakobs',          position: 'DF', club: 'Monaco' },
      { number: 20, name: 'Fodé Ballo-Touré',       position: 'DF', club: 'Fulham' },
      { number: 21, name: 'Moussa Niakhaté',        position: 'DF', club: 'Nottingham Forest' },
      // Mediocampistas
      { number: 6,  name: 'Nampalys Mendy',         position: 'MF', club: 'Nice' },
      { number: 8,  name: 'Cheikhou Kouyaté',       position: 'MF', club: 'Nottingham Forest' },
      { number: 14, name: 'Pathé Ciss',             position: 'MF', club: 'Rayo Vallecano' },
      { number: 15, name: 'Lamine Camara',          position: 'MF', club: 'Monaco' },
      { number: 17, name: 'Pape Matar Sarr',        position: 'MF', club: 'Tottenham Hotspur' },
      { number: 18, name: 'Habib Diallo',           position: 'MF', club: 'Strasbourg' },
      { number: 19, name: 'Idrissa Gueye',          position: 'MF', club: 'Everton' },
      // Delanteros
      { number: 7,  name: 'Ismaïla Sarr',           position: 'FW', club: 'Crystal Palace' },
      { number: 9,  name: 'Boulaye Dia',            position: 'FW', club: 'Lazio' },
      { number: 10, name: 'Sadio Mané',             position: 'FW', club: 'Al-Nassr' },
      { number: 11, name: 'Famara Diédhiou',        position: 'FW', club: 'Al-Qadsiah' },
      { number: 13, name: 'Nicolas Jackson',        position: 'FW', club: 'Chelsea' },
      { number: 22, name: 'Iliman Ndiaye',          position: 'FW', club: 'Marseille' },
    ],
  },
  ...
  'Irak': {
    coach: 'Jesús Casas',
    formation: '4-2-3-1',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Iraq.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Iraq_FA.png',
    players: [
      // Porteros
      { number: 1,  name: 'Jalal Hassan',           position: 'GK', club: 'Al-Zawraa' },
      { number: 12, name: 'Mohammed Hamid',         position: 'GK', club: 'Erbil SC' },
      { number: 22, name: 'Dhurgham Ismail',        position: 'GK', club: 'Al-Quwa Al-Jawiya' },
      // Defensas
      { number: 2,  name: 'Ali Adnan',              position: 'DF', club: 'Boluspor' },
      { number: 3,  name: 'Rebin Sulaka',           position: 'DF', club: 'Al-Shorta' },
      { number: 4,  name: 'Saman Ridha',            position: 'DF', club: 'Al-Zawraa' },
      { number: 5,  name: 'Mustafa Nadhim',         position: 'DF', club: 'Al-Quwa Al-Jawiya' },
      { number: 6,  name: 'Hussein Ali',            position: 'DF', club: 'Al-Naft' },
      { number: 15, name: 'Alaa Abbas',             position: 'DF', club: 'Al-Zawraa' },
      { number: 21, name: 'Saad Natiq',             position: 'DF', club: 'Al-Quwa Al-Jawiya' },
      // Mediocampistas
      { number: 7,  name: 'Amjad Attwan',           position: 'MF', club: 'Al-Shorta' },
      { number: 8,  name: 'Osama Rashid',           position: 'MF', club: 'Vitesse' },
      { number: 10, name: 'Amar Mohammed',          position: 'MF', club: 'Al-Quwa Al-Jawiya' },
      { number: 13, name: 'Ali Faez',               position: 'MF', club: 'Al-Zawraa' },
      { number: 14, name: 'Bashar Resan',           position: 'MF', club: 'Westerlo' },
      { number: 16, name: 'Aymen Hussein',          position: 'MF', club: 'Al-Shorta' },
      { number: 18, name: 'Mazin Faisal',           position: 'MF', club: 'Al-Naft' },
      // Delanteros
      { number: 9,  name: 'Alaa Ali',               position: 'FW', club: 'Al-Zawraa' },
      { number: 11, name: 'Ahmed Yasin',            position: 'FW', club: 'Al-Quwa Al-Jawiya' },
      { number: 17, name: 'Mohanad Ali',            position: 'FW', club: 'Al-Shorta' },
      { number: 19, name: 'Ibrahim Bayesh',         position: 'FW', club: 'Al-Zawraa' },
      { number: 20, name: 'Fallah Shaker',          position: 'FW', club: 'Al-Quwa Al-Jawiya' },
      { number: 23, name: 'Manaf Yousif',           position: 'FW', club: 'Al-Shorta' },
    ],
  },
  ...
  'Noruega': {
    ...
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Norway.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Norway_Football_Federation_logo.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Ørjan Nyland',           position: 'GK', club: 'Southampton' },
      { number: 12, name: 'Jørgen Strand Larsen',   position: 'GK', club: 'Celta Vigo' },
      { number: 23, name: 'Markus Kolke',           position: 'GK', club: 'Werder Bremen' },
      // Defensas
      { number: 2,  name: 'Julian Ryerson',         position: 'DF', club: 'Borussia Dortmund' },
      { number: 3,  name: 'Birger Meling',          position: 'DF', club: 'Nantes' },
      { number: 4,  name: 'Andreas Hanche-Olsen',   position: 'DF', club: 'Gent' },
      { number: 5,  name: 'Leo Skiri Østigård',     position: 'DF', club: 'Napoli' },
      { number: 6,  name: 'Stian Gregersen',        position: 'DF', club: 'Marseille' },
      { number: 15, name: 'Bard Finne',             position: 'DF', club: 'Rosenborg' },
      { number: 21, name: 'Kristian Thorstvedt',    position: 'DF', club: 'Sassuolo' },
      // Mediocampistas
      { number: 7,  name: 'Sander Berge',           position: 'MF', club: 'Fulham' },
      { number: 8,  name: 'Morten Thorsby',         position: 'MF', club: 'Union Berlin' },
      { number: 10, name: 'Martin Ødegaard',        position: 'MF', club: 'Arsenal' },
      { number: 13, name: 'Fredrik Aursnes',        position: 'MF', club: 'Benfica' },
      { number: 16, name: 'Patrick Berg',           position: 'MF', club: 'Lens' },
      { number: 17, name: 'Mathias Normann',        position: 'MF', club: 'Standard Liège' },
      { number: 20, name: 'Andreas Skov Olsen',     position: 'MF', club: 'Club Brugge' },
      // Delanteros
      { number: 9,  name: 'Erling Haaland',         position: 'FW', club: 'Manchester City' },
      { number: 11, name: 'Mohamed Elyounoussi',    position: 'FW', club: 'Fenerbahçe' },
      { number: 14, name: 'Alexander Sørloth',      position: 'FW', club: 'Atlético de Madrid' },
      { number: 18, name: 'Ola Solbakken',          position: 'FW', club: 'Roma' },
      { number: 19, name: 'Antonio Nusa',           position: 'FW', club: 'RB Leipzig' },
      { number: 22, name: 'Tobias Børkeeiet',       position: 'FW', club: 'Rosenborg' },
    ],
  },
  ...
  'Inglaterra': {
    coach: 'Thomas Tuchel',
    formation: '4-2-3-1',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_England.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/England_national_football_team_badge.svg',
    players: [
      // Porteros
      ...
      // Defensas
      { number: 2,  name: 'Ezri Konsa',             position: 'DF', club: 'Aston Villa' },
      { number: 3,  name: 'Nico O\'Reilly',         position: 'DF', club: 'Manchester City' },
      { number: 5,  name: 'John Stones',            position: 'DF', club: 'Manchester City' },
      { number: 6,  name: 'Marc Guéhi',             position: 'DF', club: 'Crystal Palace' },
      { number: 12, name: 'Tino Livramento',        position: 'DF', club: 'Newcastle United' },
      { number: 15, name: 'Dan Burn',               position: 'DF', club: 'Newcastle United' },
      { number: 24, name: 'Reece James',            position: 'DF', club: 'Chelsea' },
      { number: 25, name: 'Djed Spence',            position: 'DF', club: 'Genoa' },
      { number: 26, name: 'Jarell Quansah',         position: 'DF', club: 'Liverpool' },
      // Mediocampistas
      { number: 4,  name: 'Declan Rice',            position: 'MF', club: 'Arsenal' },
      { number: 8,  name: 'Elliot Anderson',        position: 'MF', club: 'Nottingham Forest' },
      { number: 14, name: 'Jordan Henderson',       position: 'MF', club: 'Ajax' },
      { number: 16, name: 'Kobbie Mainoo',          position: 'MF', club: 'Manchester United' },
      { number: 17, name: 'Morgan Rogers',          position: 'MF', club: 'Aston Villa' },
      { number: 21, name: 'Eberechi Eze',           position: 'MF', club: 'Crystal Palace' },
      // Delanteros
      { number: 7,  name: 'Bukayo Saka',            position: 'FW', club: 'Arsenal' },
      { number: 9,  name: 'Harry Kane',             position: 'FW', club: 'Bayern Munich' },
      { number: 10, name: 'Jude Bellingham',        position: 'FW', club: 'Real Madrid' },
      { number: 11, name: 'Marcus Rashford',        position: 'FW', club: 'Aston Villa' },
      { number: 18, name: 'Anthony Gordon',         position: 'FW', club: 'Liverpool' },
      { number: 19, name: 'Ollie Watkins',          position: 'FW', club: 'Aston Villa' },
      { number: 20, name: 'Noni Madueke',           position: 'FW', club: 'Chelsea' },
      { number: 22, name: 'Ivan Toney',             position: 'FW', club: 'Al-Ahli' },
    ],
  },
  ...
  'Croacia': {
    coach: 'Zlatko Dalić',
    formation: '4-2-3-1',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Croatia.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Croatian_Football_Federation_logo.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Dominik Livaković',      position: 'GK', club: 'Dinamo Zagreb' },
      { number: 23, name: 'Dominik Kotarski',       position: 'GK', club: 'Al-Qadsiah' },
      { number: 24, name: 'Ivor Pandur',            position: 'GK', club: 'Girona' },
      // Defensas
      { number: 2,  name: 'Josip Stanišić',         position: 'DF', club: 'Bayern München' },
      { number: 3,  name: 'Joško Gvardiol',         position: 'DF', club: 'Manchester City' },
      { number: 4,  name: 'Martin Erlić',           position: 'DF', club: 'Midtjylland' },
      { number: 5,  name: 'Duje Ćaleta-Car',        position: 'DF', club: 'Real Sociedad' },
      { number: 6,  name: 'Marin Pongračić',        position: 'DF', club: 'Fiorentina' },
      { number: 21, name: 'Josip Šutalo',           position: 'DF', club: 'Ajax' },
      { number: 22, name: 'Luka Vušković',          position: 'DF', club: 'Hamburger SV' },
      // Mediocampistas
      { number: 8,  name: 'Mateo Kovačić',          position: 'MF', club: 'Manchester City' },
      { number: 9,  name: 'Luka Sučić',             position: 'MF', club: 'Real Sociedad' },
      { number: 10, name: 'Luka Modrić',            position: 'MF', club: 'AC Milan' },
      { number: 11, name: 'Nikola Vlašić',          position: 'MF', club: 'Torino' },
      { number: 14, name: 'Mario Pašalić',          position: 'MF', club: 'Atalanta' },
      { number: 15, name: 'Kristijan Jakić',        position: 'MF', club: 'Augsburg' },
      { number: 16, name: 'Martin Baturina',        position: 'MF', club: 'Como' },
      { number: 17, name: 'Petar Sučić',            position: 'MF', club: 'Internazionale' },
      { number: 19, name: 'Nikola Moro',            position: 'MF', club: 'Bologna' },
      { number: 26, name: 'Toni Fruk',              position: 'MF', club: 'Rijeka' },
      // Delanteros
      { number: 7,  name: 'Ivan Perišić',           position: 'FW', club: 'PSV Eindhoven' },
      { number: 12, name: 'Igor Matanović',         position: 'FW', club: 'Freiburg' },
      { number: 13, name: 'Petar Musa',             position: 'FW', club: 'FC Dallas' },
      { number: 18, name: 'Andrej Kramarić',        position: 'FW', club: 'Hoffenheim' },
      { number: 20, name: 'Marco Pašalić',          position: 'FW', club: 'Orlando City SC' },
      { number: 25, name: 'Ante Budimir',           position: 'FW', club: 'Osasuna' },
    ],
  },
  ...
  'Ghana': {
    ...
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Ghana.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Ghana_Football_Association.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Lawrence Ati-Zigi',      position: 'GK', club: 'FC St. Gallen' },
      { number: 12, name: 'Joseph Anang',           position: 'GK', club: 'Leicester City' },
      { number: 16, name: 'Benjamin Asare',         position: 'GK', club: 'Kotoko SC' },
      // Defensas
      { number: 3,  name: 'Caleb Yirenkyi',         position: 'DF', club: 'Crystal Palace' },
      { number: 4,  name: 'Jerome Opoku',           position: 'DF', club: 'Udinese' },
      { number: 6,  name: 'Abdul Mumin',            position: 'DF', club: 'Rayo Vallecano' },
      { number: 13, name: 'Alidu Seidu',            position: 'DF', club: 'Stade Rennais' },
      { number: 14, name: 'Gideon Mensah',          position: 'DF', club: 'Auxerre' },
      { number: 17, name: 'Baba Abdul Rahman',      position: 'DF', club: 'Lecce' },
      { number: 18, name: 'Marvin Senaya',          position: 'DF', club: 'Auxerre' },
      { number: 23, name: 'Derrick Luckassen',      position: 'DF', club: 'PEC Zwolle' },
      { number: 24, name: 'Kwasi Sibo',             position: 'DF', club: 'Sporting Charleroi' },
      // Mediocampistas
      { number: 5,  name: 'Thomas Partey',          position: 'MF', club: 'Villarreal' },
      { number: 15, name: 'Elisha Owusu',           position: 'MF', club: 'Auxerre' },
      { number: 25, name: 'Augustine Boakye',       position: 'MF', club: 'RB Leipzig' },
      { number: 26, name: 'Prince Kwabena Adu',     position: 'MF', club: 'FC Zürich' },
      // Delanteros
      { number: 7,  name: 'Kamaldeen Sulemana',     position: 'FW', club: 'Southampton' },
      { number: 8,  name: 'Abdul Fatawu Issahaku',  position: 'FW', club: 'Leicester City' },
      { number: 9,  name: 'Jordan Ayew',            position: 'FW', club: 'Leicester City' },
      { number: 10, name: 'Brandon Thomas-Asante',  position: 'FW', club: 'West Bromwich Albion' },
      { number: 11, name: 'Antoine Semenyo',        position: 'FW', club: 'Bournemouth' },
      { number: 19, name: 'Ernest Nuamah',          position: 'FW', club: 'Olympique Lyon' },
      { number: 20, name: 'Kojo Oppong Peprah',     position: 'FW', club: 'OGC Nice' },
      { number: 21, name: 'Iñaki Williams',         position: 'FW', club: 'Athletic Club' },
      { number: 22, name: 'Christopher Bonsu Baah', position: 'FW', club: 'Molde FK' },
    ],
  },
  ...
  'Panamá': {
    ...
    formation: '4-3-3',
    flagImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/Flag_of_Panama.svg',
    crestImageUrl: 'https://commons.wikimedia.org/wiki/Special:FilePath/FEPAFUT_logo.svg',
    players: [
      // Porteros
      { number: 1,  name: 'Orlando Mosquera',       position: 'GK', club: 'Al-Fayha' },
      { number: 12, name: 'Luis Mejía',             position: 'GK', club: 'Club Nacional' },
      { number: 23, name: 'César Samudio',          position: 'GK', club: 'CD Marathon' },
      // Defensas
      { number: 2,  name: 'César Blackman',         position: 'DF', club: 'Slovan Bratislava' },
      { number: 3,  name: 'Jorge Gutiérrez',        position: 'DF', club: 'Deportivo La Guaira' },
      { number: 4,  name: 'Fidel Escobar',          position: 'DF', club: 'Deportivo Saprissa' },
      { number: 5,  name: 'Edgardo Fariña',         position: 'DF', club: 'Pari Nizhny Novgorod' },
      { number: 6,  name: 'Andrés Andrade',         position: 'DF', club: 'LASK' },
      { number: 13, name: 'José Córdoba',           position: 'DF', club: 'Norwich City' },
      { number: 15, name: 'Roderick Miller',        position: 'DF', club: 'Turan Tovuz' },
      { number: 22, name: 'Amir Murillo',           position: 'DF', club: 'Beşiktaş' },
      { number: 24, name: 'Jiovani Ramos',          position: 'DF', club: 'Academia Puerto Cabello' },
      { number: 25, name: 'Eric Davis',             position: 'DF', club: 'CD Plaza Amador' },
      // Mediocampistas
      { number: 8,  name: 'Aníbal Godoy',           position: 'MF', club: 'San Diego FC' },
      { number: 10, name: 'Adalberto Carrasquilla', position: 'MF', club: 'Pumas UNAM' },
      { number: 11, name: 'Cesar Yanis',            position: 'MF', club: 'CD Cobresal' },
      { number: 14, name: 'Carlos Harvey',          position: 'MF', club: 'Minnesota United FC' },
      { number: 16, name: 'Yoel Bárcenas',          position: 'MF', club: 'Mazatlán FC' },
      { number: 17, name: 'Cristian Martínez',      position: 'MF', club: 'Ironi Kiryat Shmona' },
      { number: 18, name: 'José Luis Rodríguez',    position: 'MF', club: 'FC Juárez' },
      { number: 19, name: 'Alberto Quintero',       position: 'MF', club: 'CD Plaza Amador' },
      { number: 21, name: 'Azarías Londoño',        position: 'MF', club: 'CD Universidad Católica' },
      // Delanteros
      { number: 7,  name: 'Ismael Díaz',            position: 'FW', club: 'Club León' },
      { number: 9,  name: 'Cecilio Waterman',       position: 'FW', club: 'Universidad de Concepción' },
      { number: 20, name: 'José Fajardo',           position: 'FW', club: 'CD Universidad Católica' },
      { number: 26, name: 'Tomás Rodríguez',        position: 'FW', club: 'Deportivo Saprissa' },
    ],
  },
